...
conn = pymysql.connect(host="localhost", user="root", password="15478xx", db="scrapy", port=3306, charset="utf8")
cursor = conn.cursor()
...
def crawl_ips():
    ...
    for i in range(5):
        ...
        for ip_info in ip_list:
            insert_sql = """insert into xici_ip_pool(ip,port,speed,proxy_type) values('{0}','{1}',{2},'HTTP')""".format(
